...
I’m a fourth-year PhD student in [UKRI Centre for Doctoral Training in Artificial Intelligence and Music](https://www.aim.qmul.ac.uk/) programme at C4DM, Queen Mary University of London, supervised by Dr. [György Fazekas](http://www.eecs.qmul.ac.uk/~gyorgyf/).
...
- [philtorch](https://github.com/yoyolicoris/philtorch): efficient implementation of various linear filtering operations in PyTorch.
- [diffvox](https://github.com/SonyResearch/diffvox): a set of differentiable audio effects for vocal processing in PyTorch.
...
My research interests include all aspects of audio signal processing, music information retrieval, binaural audio, generative modelling, and machine learning.
...
- [kamui](https://github.com/yoyolicoris/kamui): phase unwrapping using integer linear programming.
...
My hobbies are music, manga, anime, and vtubers. My music taste is very broad and ranges from Heavy Metal, Djent, Post-Hardcore, to Happy Hardcore, Trance, Kawaii Future Bass, Ani-Song, Lo-Fi, Breakcore, etc. I also made music (see my [portfolio](/music/) page) under the name **Y.C.Y**.
